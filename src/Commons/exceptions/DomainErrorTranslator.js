...
DomainErrorTranslator._directories = {
  ...
  'GET_DETAIL_THREAD_WITH_COMMENTS_AND_REPLIES_USE_CASE.NOT_CONTAIN_THREAD_ID': new InvariantError('tidak dapat mendapatkan detail thread dengan komentar dan balasan karena properti yang dibutuhkan tidak ada'),
  'GET_DETAIL_THREAD_WITH_COMMENTS_AND_REPLIES_USE_CASE.PAYLOAD_NOT_MEET_DATA_TYPES_SPECIFICATION': new InvariantError('tidak dapat mendapatkan detail thread dengan komentar dan balasan karena tipe data tidak sesuai'),
};
